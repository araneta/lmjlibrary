...
import views.html._
/**/
object borrowedbooks extends BaseScalaTemplate[play.api.templates.Html,Format[play.api.templates.Html]](play.api.templates.HtmlFormat) with play.api.templates.Template0[play.api.templates.Html] {
...
"""),_display_(Seq[Any](/*10.2*/main(styles,scripts)/*10.22*/ {_display_(Seq[Any](format.raw/*10.24*/("""     
	...
	<script type="text/javascript">
	  ...
	  $(document).ready(function() """),format.raw("""{"""),format.raw/*14.34*/("""
	    $('#borrowedbooks').dataTable( """),format.raw("""{"""),format.raw/*15.38*/("""
	      "bProcessing": true,
	      "aaSorting": [[ 0, "asc" ]],
	      "bServerSide": true,
	      "bJQueryUI": true,
	      "sPaginationType": "full_numbers",
	      "sAjaxSource": """"),_display_(Seq[Any](/*21.25*/routes/*21.31*/.Reports.listBorrowedBooks())),format.raw/*21.59*/("""",
	      "sDom": '<"toolbar">frtip',
...
"""))}
    ...
    def ref = this
                ...
                /*
                    ...
                    SOURCE: /media/05beb903-1c3b-4a06-86d8-300b323446db/home/aldo/projects/play/lmjlibrary/app/views/reports/borrowedbooks.scala.html
                    HASH: 482bc72f80a3ba95d10f3bbb0af35e388c4ea9a0
